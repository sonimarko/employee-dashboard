odoo.define('employee.dashboard', function (require) {
    "use strict";
    ...
    let dashboardValues;
    SampleServer.mockRegistry.add('hr.employee/retrieve_dashboard', () => {
    ...
    var EmployeeDashboardRenderer = ListRenderer.extend({
        ...
        _renderView: function () {
            ...
            return this._super.apply(this, arguments).then(function () {
                ...
                var employee_dashboard = QWeb.render('nrs_employee_dashboard.EmployeeDashboard', {
                    values: values,
                });
                self.$el.prepend(employee_dashboard);
            });
        },
    ...
    var EmployeeDashboardModel = ListModel.extend({
        /**
         * @override
         */
        init: function () {
    ...
    var EmployeeDashboardController = ListController.extend({
    ...
    var EmployeeDashboardView = ListView.extend({
        config: _.extend({}, ListView.prototype.config, {
            Model: EmployeeDashboardModel,
            Renderer: EmployeeDashboardRenderer,
            Controller: EmployeeDashboardController,
        }),
    });
    
    view_registry.add('employee_dashboard', EmployeeDashboardView);
    
    return {
        EmployeeDashboardModel: EmployeeDashboardModel,
        EmployeeDashboardRenderer: EmployeeDashboardRenderer,
